...
// ── Row interfaces para type-safety ─────────────────────────────────────────
...
export const getStats = asyncWrapper(async (req: Request, res: Response) => {
  ...
  // 1. Resumen general de citas e ingresos (una sola query)
  ...
  // 2. Gráfico diario (agrupado por fecha)
  ...
  // 3. Clientes totales y recurrentes (una sola query con subquery)
  ...
  // 4b. Inventario - top 5 productos por stock
  ...
  // 5. Ranking de staff por ingresos
