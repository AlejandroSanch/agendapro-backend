 ...
 */
export async function listSystemNotifications(tenantDb: string, limit = 50): Promise<SystemNotification[]> {
 ...
 */
export async function createSystemNotification(tenantDb: string, data: {
  type: string;
  title: string;
  message: string;
  metadata?: any;
