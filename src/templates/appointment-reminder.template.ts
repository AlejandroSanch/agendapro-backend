/**
 * Template HTML para el correo de recordatorio de cita.
 * Replica el diseño tipo ticket de la página de confirmación,
 * con Establecimiento, Servicio, Especialista, Fecha, Hora, Ubicación.
 */
...
<head>
  ...
  <title>Recordatorio de cita - AgendaPro</title>
</head>
    ...
    <tr>
      <td align="center">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:480px;background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.06);">
          ...
          <!-- Header -->
          <tr>
            <td style="background:linear-gradient(135deg,#4f46e5 0%,#6366f1 50%,#818cf8 100%);padding:28px 32px 24px;text-align:center;">
          ...
          <tr>
            <td style="padding:32px 32px 0;text-align:center;">
              ...
              <p style="margin:0 0 24px;font-size:15px;color:#64748b;line-height:1.5;">
                Por favor, confirma los detalles de tu cita:
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:0 24px;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f1f5f9;border-radius:16px;border-left:4px solid #6366f1;">
                ...
                <tr>
                  <td style="padding:20px 20px 0;">
                    ...
                    <p style="margin:0;font-size:15px;font-weight:800;color:#6366f1;line-height:1.4;">
                      ${businessName}
                    </p>
                  </td>
                </tr>
          ...
          <tr>
            <td style="padding:28px 24px 12px;" align="center">
              <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  <td align="center">
                    <a href="${confirmLink}" target="_blank" style="display:block;width:100%;background:#6366f1;color:#ffffff;text-decoration:none;font-weight:700;font-size:16px;padding:16px 0;border-radius:14px;text-align:center;box-shadow:0 10px 15px -3px rgba(99,102,241,0.3);">
          ...
          <tr>
            <td style="background:#f8fafc;padding:18px 32px;text-align:center;border-top:1px solid #e2e8f0;">
              <p style="margin:0;font-size:12px;color:#94a3b8;line-height:1.5;">
                &copy; ${year} AgendaPro &middot; Gestión inteligente para tu negocio
              </p>
            </td>
          </tr>
...
/**
 * Genera el texto plano del correo (mismo contenido que WhatsApp).
 */
export function buildAppointmentReminderText(params: AppointmentReminderParams): string {
  const { customerName, appointmentTitle, dateTimeStr, confirmLink } = params;
  return `Hola ${customerName}, recordatorio de tu cita ("${appointmentTitle}") para el ${dateTimeStr}. ¿Nos acompañas? Confirma tu asistencia aquí: ${confirmLink}`;
}
